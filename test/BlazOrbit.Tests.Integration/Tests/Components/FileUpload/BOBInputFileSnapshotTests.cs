...
public class BOBInputFileSnapshotTests
{
    ...
    public async Task Should_Match_Snapshots_For_Variants_And_States(BlazorScenario scenario)
    {
        ...
        var testCases = new[]
        {
            ...
            new { Name = "Multiple_With_Accept", Builder = (Action<ComponentParameterCollectionBuilder<BOBInputFile>>)(p => p
                .Add(c => c.Multiple, true)
                .Add(c => c.Accept, "image/*")
                .Add(c => c.Label, "Images")) },

            new { Name = "Disabled", Builder = (Action<ComponentParameterCollectionBuilder<BOBInputFile>>)(p => p
                .Add(c => c.Disabled, true)
                .Add(c => c.Label, "Disabled")) },

            new { Name = "Custom_Texts", Builder = (Action<ComponentParameterCollectionBuilder<BOBInputFile>>)(p => p
