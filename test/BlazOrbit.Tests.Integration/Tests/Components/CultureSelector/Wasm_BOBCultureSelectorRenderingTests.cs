...
using BOBCultureSelector = BlazOrbit.Components.Wasm.BOBCultureSelector;
using BOBCultureSelectorVariant = BlazOrbit.Localization.Shared.BOBCultureSelectorVariant;
using LocalizationSettings = BlazOrbit.Localization.Wasm.WasmLocalizationSettings;

namespace BlazOrbit.Tests.Integration.Tests.Components.CultureSelector;

[Trait("Component Rendering", "BOBCultureSelector")]
public class Wasm_BOBCultureSelectorRenderingTests : TestFixtureBase<WasmTestContext>
{
    public Wasm_BOBCultureSelectorRenderingTests(WasmTestContext context) : base(context)
    {
    }
