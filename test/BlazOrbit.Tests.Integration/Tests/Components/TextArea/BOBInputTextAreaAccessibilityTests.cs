...
[Trait("Component Accessibility", "BOBInputTextArea")]
public class BOBInputTextAreaAccessibilityTests
{
    ...
    public async Task Should_Expose_AriaLabel_From_Placeholder_When_No_Label(BlazorScenario scenario)
    {
        ...
        cut.Find("textarea.bob-input__field").GetAttribute("aria-label").Should().Be("Type here");
    }
    ...
    public async Task Should_Not_Emit_AriaLabel_When_Label_Provided(BlazorScenario scenario)
    {
        ...
        cut.Find("textarea.bob-input__field").GetAttribute("aria-label").Should().BeNullOrEmpty();
    }
    ...
    public async Task Should_Emit_AriaRequired_Matching_Required_Parameter(BlazorScenario scenario)
    {
        ...
        cut.Find("textarea.bob-input__field").GetAttribute("aria-required").Should().Be("true");
        ...
        cut.Find("textarea.bob-input__field").GetAttribute("aria-required").Should().Be("false");
    }
    ...
    public async Task Should_Link_AriaDescribedBy_To_Helper_Id(BlazorScenario scenario)
    {
        ...
        string? describedBy = cut.Find("textarea.bob-input__field").GetAttribute("aria-describedby");
    ...
    {
        // CSS-OPT-02 block B.5: visual marker is now CSS-only via
