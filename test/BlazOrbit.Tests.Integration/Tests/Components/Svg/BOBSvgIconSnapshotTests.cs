...
{
    private static readonly IconKey TriangleIcon =
        new("TriangleIcon") { SvgContent = "<path d=\"M12 2L2 22h20L12 2z\"/>" };

    private static readonly IconKey CircleIcon =
        new("CircleIcon") { SvgContent = "<circle cx=\"12\" cy=\"12\" r=\"10\"/>" };

    private static readonly IconKey StarIcon =
        new("StarIcon") { SvgContent = "<path d=\"M12 2l3 6 7 1-5 5 1 7-6-3-6 3 1-7-5-5 7-1z\"/>" };
