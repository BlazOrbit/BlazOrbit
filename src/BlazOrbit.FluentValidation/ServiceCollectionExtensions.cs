...
{
#if NET10_0
    // .NET 10+: use C# 14 extension types for a cleaner, instance-based API.
...
#else
    // .NET 8: traditional extension methods (C# 14 extension types are not available).
    ...
    /// <param name="includeInternalTypes">Whether to include internal validators.</param>
    /// <returns>The same <see cref="IServiceCollection" /> for chaining.</returns>
    public static IServiceCollection AddBOBFluentValidation<TEntry>(
    ...
    /// <param name="includeInternalTypes">Whether to include internal validators.</param>
    /// <returns>The same <see cref="IServiceCollection" /> for chaining.</returns>
    public static IServiceCollection AddBOBFluentValidation(
        this IServiceCollection services,
        Assembly? assembly = null,
        ServiceLifetime lifetime = ServiceLifetime.Scoped,
        Func<AssemblyScanner.AssemblyScanResult, bool>? filter = null,
