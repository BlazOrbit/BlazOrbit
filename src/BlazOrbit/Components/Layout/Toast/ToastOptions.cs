...
public sealed class ToastOptions
{
    ...
    public static ToastOptions Long => new() { AutoDismiss = true, Duration = TimeSpan.FromSeconds(10) };

    /// <summary>Sticky preset — never auto-dismisses, always closable.</summary>
    public static ToastOptions Persistent => new() { AutoDismiss = false, Closable = true };

    /// <summary>2 s auto-dismiss preset.</summary>
    public static ToastOptions Quick => new() { AutoDismiss = true, Duration = TimeSpan.FromSeconds(2) };
