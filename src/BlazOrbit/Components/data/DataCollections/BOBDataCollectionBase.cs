    ...
    where TVariant : Variant
{
    ...
    [Inject]
    protected IStringLocalizer<BOBDataResources> Localizer { get; set; } = default!;
    ...
    /// </summary>
    protected void HandleHeaderDragStart(string columnName, Microsoft.AspNetCore.Components.Web.DragEventArgs e)
    {
    ...
    /// </summary>
    protected void HandleHeaderDragOver(string columnName, Microsoft.AspNetCore.Components.Web.DragEventArgs e)
    {
        if (!Reorderable)
        {
            return;
    ...
    /// </summary>
    protected void HandleHeaderDrop(string targetHeader, Microsoft.AspNetCore.Components.Web.DragEventArgs e)
    {
    ...
    protected void HandleHeaderDragEnd(Microsoft.AspNetCore.Components.Web.DragEventArgs e) => _draggingColumnHeader = null;
